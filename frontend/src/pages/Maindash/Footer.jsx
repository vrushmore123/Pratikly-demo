 ...
 * 
 * This component displays the footer of the webpage, which includes:
 * - Company information and GDPR compliance.
 * - Navigation links to various sections of the website.
 * - Contact information with options to get a demo and connect via email or LinkedIn.
 * - Language preferences and a button to toggle the theme.
 * - Footer bottom section with links to privacy, terms, and cookie policies.
 * 
 * The component utilizes the useLanguage hook to manage language preferences
 * and includes icons from 'react-icons/fa' and 'react-icons/hi'.
 */

/*******  8ad3b728-2c76-423d-a2af-bc63d24f2ec3  *******/
const Footer = () => {
